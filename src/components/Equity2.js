...
const Equity2 = ({ tabValue }) => {
    ...
    // State to hold currency data from JSON
    ...
    useEffect(() => {
        // Fetch the equities data
        fetchEquities(dispatch);

        // Fetch the currency data from the public folder
            ...
            <Dialog open={state.isModalOpen} onClose={handleModalClose}>
                ...
                <DialogContent>
                    ...
                    <TextField
                        ...
                        fullWidth
                        InputLabelProps={{ shrink: true }}
                        error={!!errorMessages.dividendDeclaredDate}
                        helperText={errorMessages.dividendDeclaredDate}
                    />
